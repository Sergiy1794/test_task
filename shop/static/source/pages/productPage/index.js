...
/******/ 	return __webpack_require__(__webpack_require__.s = "./productPage.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "../components/pages/productPage/index.js":
/*!************************************************!*\
  !*** ../components/pages/productPage/index.js ***!
  \************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.scss */ "../components/pages/productPage/index.scss");
/* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_index_scss__WEBPACK_IMPORTED_MODULE_0__);
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
var sliderNavbar = $('.sliderNavbar').slick({
  slidesToShow: 3,
  slidesToScroll: 1,
...
function widthSliderFooter() {
  var allSliderGalery = $('.product__gallery').width();
  var widthNavbar = allSliderGalery * 0.8;
  var widthBoxVideo = allSliderGalery * 0.2;
...
var ProductCard = /*#__PURE__*/function () {
  ...
  _createClass(ProductCard, [{
    ...
    value: function showProductDescription() {
      _toConsumableArray($('.product__description')).map(function (item) {
        $(item).children('.header').on('click', function () {
...
/***/ "../components/pages/productPage/index.scss":
/*!**************************************************!*\
  !*** ../components/pages/productPage/index.scss ***!
  \**************************************************/
/*! no static exports found */
...
/* harmony import */ var _components_pages_productPage_index__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/pages/productPage/index */ "../components/pages/productPage/index.js");
// script interface
